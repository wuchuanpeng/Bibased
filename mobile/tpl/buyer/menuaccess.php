  ...
  <style type="text/css">
	...
	<body>
		<header class="mui-bar mui-bar-nav"style="background-color: #fff;">
		    ...
		    <button type="button" id = "submit-access" class="mui-pull-right mui-btn-success put-btn"style="margin-top: 6px;">提交</button>
		</header>
		<div class="mui-content">
		    ...
		    <div class="seller-shop seller-out">
		    	<div class="seller-top"style="width: 94%;margin: 0 auto;">
		    		<img src="{$orderInfo.S_ShopImgUrl}"style="width: 40px;height: 40px;"class="seller-icon"/>
		    		<h5 style="margin-top: 30px;color: #000;float: left;margin-left: 8px;">{$orderInfo.S_ShopName}</h5>
		    	</div>
		    	<div class="seller-access">
		    ...
		    <div class="gocomment">
		    	<div class="tocomment">
		    	    ...
		    	    <a href="javascript:;"class="addimg"id="addimg" style="position:relative;">
                        <div style="display:none; position:absolute;top: -10px;left: 60%;z-index:100;cursor: pointer;" id="clear-img" ><img src="buyerstyle/image/access-shut.png"/></div>
                        <input id="access-img" type="file" name="access-img" style="display:block;width: 100%;height: 100%; position:absolute;top: 0px;left: 0px;z-index:99;opacity:0;filter:alpha(opacity=0) ">
                        <img id="access_show_img" style="width: 82px;height: 82px"; src="buyerstyle/image/addimg-icon.png"/>
    ...
    <script src="buyerstyle/js/ajaxfileupload.js"></script>
...
//			var old_back=mui.back;
			...
			document.getElementById("submit-access").addEventListener("tap", function () {
                if (star == 0) {
                    mui.toast("请为商家打分");
                    return false;
                }
                ...
                doajax("admin.php?controller=userorder&method=submitAccess",{
                    E_OID:oid,
                    E_Score:star,
                    E_Content:content,
                    imgurl:$("#imgUrl").val()
...
//					aslide4.className='show';
            ...
            $("#access-img").change(function () {
                $.ajaxFileUpload
                (
                    {
                        url:'admin.php?controller=userorder&method=accessFileUpload', //你处理上传文件的服务端
                        secureuri:false,
                        fileElementId:'access-img',
                        data:{},
                        dataType: 'json',
			...
			document.getElementById("clear-img").addEventListener("tap",function (event) {
                $("#access_show_img").attr("src","buyerstyle/image/addimg-icon.png");
                $("#imgUrl").val("");
